...
public class RenderTileEntityObj1 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj1)tile, x, y, z, f);
	}

	private void render(TileEntityObj1 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
